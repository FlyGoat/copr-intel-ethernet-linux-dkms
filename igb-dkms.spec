%global dkms_name igb
%global upstream_repo intel/ethernet-linux-igb
%global _disable_source_fetch 0

Name:           igb-dkms
Version:        5.20.28
Release:        1%{?dist}
Summary:        DKMS package for the Intel Gigabit Ethernet driver
...
%description
This package installs Intel's out-of-tree igb driver sources under
...
%changelog
* Thu Jun 25 2026 FlyGoat <flygoat@users.noreply.github.com> - 5.20.28-1
- Initial DKMS package for Intel igb.
